                    ...
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="img/slide-01.gif">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-02.gif">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/slide-03.jpg">
                            </div>
